...
function trimLog() {
  // ⚡ Bolt Optimization: Use a high-water mark buffer to prevent frequent
  // O(N^2) element shifting caused by .splice() on large arrays. Wait until
  // log length exceeds MAX + BUFFER before batch-trimming it down to MAX.
