...
describe('popup.html accessibility', () => {
  ...
  it('should use semantic fieldset and legend tags for grouping options', () => {
    assert.ok(popupHtml.includes('<fieldset'), 'fieldset element should be present')
    assert.ok(popupHtml.includes('<legend id="execModeLabel"'), 'execModeLabel should be a legend')
    assert.ok(popupHtml.includes('<legend id="scopeLabel"'), 'scopeLabel should be a legend')
  })
})
