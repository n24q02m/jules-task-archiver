...
describe('popup.html accessibility', () => {
  ...
  it('should use semantic fieldset and legend for grouping', () => {
    assert.ok(popupHtml.includes('<fieldset'), 'should use fieldset elements')
    assert.ok(popupHtml.includes('<legend'), 'should use legend elements')
    assert.ok(popupHtml.includes('Execution Mode'), 'should have Execution Mode legend')
    assert.ok(popupHtml.includes('Scope'), 'should have Scope legend')
  })
})
