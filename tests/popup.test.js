...
describe('popup.html accessibility', () => {
  ...
  it('should use semantic fieldset and legend for form control groups', () => {
    assert.ok(popupHtml.includes('<fieldset'), 'fieldset element should exist')
    assert.ok(popupHtml.includes('<legend id="execModeLabel"'), 'legend with id execModeLabel should exist')
    assert.ok(popupHtml.includes('<legend id="scopeLabel"'), 'legend with id scopeLabel should exist')
  })
})
