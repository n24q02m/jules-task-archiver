...
describe('popup.html accessibility', () => {
  ...
  it('should use explicit visible labels for radio groups via semantic fieldset/legend', () => {
    assert.ok(popupHtml.includes('id="execModeLabel"'), 'execModeLabel should exist')
    assert.ok(popupHtml.includes('<fieldset class="setting-row">'), 'mode radiogroup should use fieldset')
