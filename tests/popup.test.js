...
describe('popup.html accessibility', () => {
  ...
  it('should use semantic fieldset and legend for grouping', () => {
    assert.ok(popupHtml.includes('<fieldset'), 'should use fieldset for grouping')
    assert.ok(popupHtml.includes('<legend'), 'should use legend for grouping')
    assert.ok(popupHtml.includes('Operation</legend>'), 'Operation legend should exist')
    assert.ok(popupHtml.includes('Execution Mode</legend>'), 'Execution Mode legend should exist')
    assert.ok(popupHtml.includes('Scope</legend>'), 'Scope legend should exist')
  })
})
