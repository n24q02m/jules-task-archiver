...
## 2025-06-31 - Missing form validation bindings
**Learning:** Native HTML5 validation attributes (like `pattern` and `maxlength`) and implicit 'Enter' key submission are bypassed if the primary action button is not inside a semantic `<form>` element.
