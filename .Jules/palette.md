...
## 2023-10-18 - Native Form Validation for Extension Popups
**Learning:** Native HTML5 validation attributes (`pattern`, `maxlength`) and implicit "Enter" key submission are bypassed in extension popups if the primary action button is not inside a semantic `<form>` element.
